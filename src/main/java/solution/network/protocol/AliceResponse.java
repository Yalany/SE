package solution.network.protocol;
...
public final class AliceResponse {
  ...
  public static final class Response {
     ...
     *  Все указанные кнопки выводятся после основного ответа Алисы, описанного в свойстве  response.text.
     *  Кнопки можно использовать как подсказки для продолжения разговора.
     */
